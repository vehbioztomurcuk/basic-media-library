...
//anti- robot (Spam honeypot)
        ...
        if(!isset($error_message)) {
                    ...
                    $email_body .= "Details " . $details . "\n";
                            ...
                            $mail->Username = "vehbi.oztomurcuk@gmail.com";
                        ...
                        $mail->setFrom('vehbi.oztomurcuk@gmail.com', $name);
                        $mail->addReplyTo($email, $name);
                        $mail->addAddress('vehbi.oztomurcuk@gmail.com', 'Vehbi Oztomurcuk');
